...
CATALOG: dict[tuple, CatalogEntry] = {
    ("render", "blender", True): CatalogEntry(
        ...
        entrypoint_template=(
            ...
            "--python-expr \"import base64; exec(base64.b64decode(b'').decode('utf-8'))\" "
